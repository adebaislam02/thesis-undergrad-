...
def call_mistral32(prompt):
    ...
    if response.status_code == 200:
        ...
        if "choices" in response_json and len(response_json["choices"]) > 0:
            ...
            if content:
                # --- BEGIN PATCH ---
                # Remove surrounding triple backticks and 'json' marker if present
...
if __name__ == "__main__":
    ...
    output_path = 'mistral_batch_one_shot_results_unmerged_mistral.csv'
