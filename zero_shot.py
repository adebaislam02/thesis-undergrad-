...
def batch_process_zero_shot(df: pd.DataFrame, output_path: str = 'batch_zero_shot_results_gpt4o.csv') -> pd.DataFrame:
...
if __name__ == "__main__":
    ...
    output_path = 'batch_zero_shot_results_gpt4o_300.csv'
