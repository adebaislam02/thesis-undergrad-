...
def build_zero_shot_prompt(row: pd.Series) -> str:
    ...
    """
    pr_block = render_pr_block(row, use_notes=False)
...
def batch_process_zero_shot(df: pd.DataFrame, output_path: str = 'batch_zero_shot_results.csv') -> pd.DataFrame:
...
if __name__ == "__main__":
    ...
    output_path = 'mistral_batch_zero_shot_results.csv'
