...
def batch_process_one_shot(df: pd.DataFrame, example_index: int = 0, output_path: str = 'batch_one_shot_results_prinfo.csv') -> pd.DataFrame:
...
if __name__ == "__main__":
    ...
    output_path = 'batch_one_shot_results_for_300_gpt4o_merged_prinfo.csv'
