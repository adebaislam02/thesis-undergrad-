...
def build_one_shot_prompt(df: pd.DataFrame, example_index: int, target_row: pd.Series) -> str:
    ...
    tgt_block = render_pr_block(target_row, use_notes=False, is_example=False)
...
def batch_process_one_shot(df: pd.DataFrame, example_index: int = 0, output_path: str = 'batch_one_shot_results_prinfo_code.csv') -> pd.DataFrame:
...
if __name__ == "__main__":
    ...
    output_path = 'batch_one_shot_results_for_300_gpt4o_merged_prinfo_code.csv'
